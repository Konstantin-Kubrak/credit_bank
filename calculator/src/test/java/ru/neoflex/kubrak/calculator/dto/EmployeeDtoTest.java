...
@SpringBootTest
@DisplayName("Module testing - validation EmployeeDto:")
class EmployeeDtoTest {
    ...
    private static Stream<Arguments> invalidExperienceProvider() {
        ...
        return Stream.of(
                ...
                Arguments.of("total", -1, "Total work experience must be at least 18 month"),
                ...
                Arguments.of("current", -1, "Current work experience must be at least 3 month")
        );
    }
